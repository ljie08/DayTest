...
+ (DateCountDown *)getCountDownWithTimeInterval:(double)time passTime:(CGFloat)passTime {
    
    DateCountDown *down = [[DateCountDown alloc] init];
    
    NSInteger hour = (time - passTime)/1000/60/60;
    NSInteger day = hour/24;
    NSInteger minute = (NSInteger)((time - passTime)/1000/60)%60;
    NSInteger second = (NSInteger)(time - passTime)/1000%60;
    NSInteger mSecond = (NSInteger)(time - passTime)%1000/100;
    ...
    down.millionsecond = mSecond>9 ? [NSString stringWithFormat:@"%ld", mSecond] : [NSString stringWithFormat:@"0%ld", mSecond];
